...
urlpatterns = [
    ...
    path('delete_registered_child/<int:pk>/', RegisterChildToCompViewSet.as_view({'delete': 'delete'}), name='delete_registered_child'),
    ...
    path('delete_work/<int:pk>/', ChildWorkViewSet.as_view({'delete': 'delete'}), name='delete_work'),
]
