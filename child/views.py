...
from konkurs_admin.serializers import ParticipantSerializer
...
class ChildViewSet(ViewSet):
    ...
    #         ),
    #     },
    #     operation_summary="Register a child",
...
class RegisterChildToCompViewSet(ViewSet):
    ...
    #             'physical_certificate': openapi.Schema(type=openapi.TYPE_FILE,
    #                                                    description='Upload physical certificate file'),
    #         },
    #         required=['name', 'competition', 'physical_certificate']
    #     ),
...
class ChildWorkViewSet(ViewSet):  # *
    ...
    #         },
    #         required=['participant', 'competition', 'files']
    #     ),
    ...
    def create(self, request, *args, **kwargs):
        ...
        for file in files:
            ChildWork.objects.create(participant=participant, competition=competition, files=file)
